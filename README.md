...
## Environments
- Preview: https://main--aem-bp-forms-fileupload--lovelymandal16.hlx.page/
- Live: https://main--aem-bp-forms-fileupload--lovelymandal16.hlx.live/
...
1. Open the `aem-bp-forms-fileupload` directory in your favorite IDE and start coding :)
